...
#define QYYCY_URL_BALANCE   		("http://qy.gz.1251102575.clb.myqcloud.com/admin/index.php?route=qingyou/cq_balance")
...
#define FILE_ORDER_BALANCE          (".\\data\\order_balance.txt")
