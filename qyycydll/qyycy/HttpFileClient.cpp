...
LPCTSTR CHttpFileClient::GetToken()
{
    return m_strToken;
}
...
BOOL CHttpFileClient::CanWebsiteVisit(LPCTSTR sURI)
{
...
BOOL CHttpFileClient::Login(LPCTSTR sURI, LPCTSTR szUsername, LPCTSTR szPassword, LPCTSTR redirectURL)
{
    CHttpConnection     * pHttpConn = NULL;
    CHttpFile           * pHttpFile = NULL;
    CInternetSession    session;
